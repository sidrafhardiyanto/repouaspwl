...
<div class="card mb-3">
        @if ($posts[0]->image)
        <img src="{{ asset('storage/'.$posts[0]->image) }}" class="card-img-top" alt="" style="max-height: 350px; overflow: hidden;">
        @else
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                ...
                @if ($post->image)
                <img src="{{ asset('storage/'.$post->image) }}" class="card-img-top" alt="" style="max-height: 400px; overflow: hidden;">
                @else
